  ...
  for (let cycle = 0; cycle < hiit.cycles; cycle++) {
    for (let round = 0; round < hiit.rounds; round++) {
      stepsTemp.push({
        ...
        information: `${hiit.workTime} ${t('time.seconds')}`,
        automatic: true,
        isRest: false,
        weight: null,
        color: null,
      ...
      stepsTemp.push({
        ...
        information: `${hiit.restTime} ${t('time.seconds')}`,
        automatic: true,
        isRest: true,
        weight: null,
        color: null,
    ...
    if (cycle < hiit.cycles - 1) {
      stepsTemp.push({
        ...
        information: `${hiit.cycleRestTime} ${t('time.seconds')}`,
        automatic: true,
        isRest: true,
        weight: null,
        color: null,
  ...
  for (let cycle = 0; cycle < emom.cycles; cycle++) {
    for (let round = 0; round < emom.rounds; round++) {
      stepsTemp.push({
        ...
        information: `${emom.workTime} ${t('time.seconds')}`,
        automatic: true,
        isRest: false,
        weight: null,
        color: null,
  ...
  for (let cycle = 0; cycle < tabata.cycles; cycle++) {
    for (let round = 0; round < tabata.rounds; round++) {
      stepsTemp.push({
        ...
        information: `${tabata.workTime} ${t('time.seconds')}`,
        automatic: true,
        isRest: false,
        weight: null,
        color: null,
      ...
      stepsTemp.push({
        ...
        name: t('convert_routine.rest'),
        information: `${tabata.restTime} ${t('time.seconds')}`,
        automatic: true,
        isRest: true,
        weight: null,
        color: null,
    ...
    if (cycle < tabata.cycles - 1) {
      stepsTemp.push({
        ...
        name: t('convert_routine.cycle_rest'),
        information: `${tabata.cycleRestTime} ${t('time.seconds')}`,
        automatic: true,
        isRest: true,
        weight: null,
        color: null,
...
export const convertAmrapToSteps = (amrap: Amrap, t: TFunction): Step[] => {
  ...
  stepsTemp.push({
    ...
    information: `${amrap.workTime} ${t('time.seconds')}`,
    automatic: true,
    isRest: false,
    weight: null,
    color: null,
